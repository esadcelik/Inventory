...
<script type="text/javascript" src="edit_inventory_ajax.js"></script>
...
<input class="btn btn-info btn-sm btn-block" role="button" id="stock_d" type="submit" name="stock_d" value="Sil">
<input class="btn btn-info btn-sm btn-block" role="button" id="stock_e" type="submit" name="stock_e" value="Düzenle">
